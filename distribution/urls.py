...
urlpatterns = patterns('',
    ...
    url(r'^editorderheader/(?P<order_id>\d+)/$', edit_order_header,
        name="edit_order_header"),
    ...
    url(r'^newcustomerpayment/(?P<customer_id>\d+)/$',
        new_customer_payment),
    url(r'^editcustomerpayment/(?P<payment_id>\d+)/$',
